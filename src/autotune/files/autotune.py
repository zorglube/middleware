...
GENERATED_COMMENT = 'Generated by autotune'
...
def main(argv):
    ...
    for var, value in recommendations.items():
        ...
        if qs:
            ...
            # We also want to avoid changing user-defined tunables.
            if obj['type'].lower() == args.conf and (
                obj['value'] == value or obj['comment'] != GENERATED_COMMENT):
                continue
        else:
            obj = {}
        obj['var'] = var
